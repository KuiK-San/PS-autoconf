<x-app-layout>
    ...
    <x-slot name="header" class="d-flex align-items-center">
        <div class="col-1">
            <h2 class="fw-bolder ">Veiculos</h2>
        </div>
        <div class="col-2 offset-11"><button type="button" class="btn btn-primary bg-primary"><a href="{{ route('veiculo.create') }}">Criar Veiculo</a></button></div>
    </x-slot>
                   ...
                   <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $veiculo->preco}}</td>
                                <td>
                                    <button type="button" class="btn btn-primary text-bg-primary p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                            <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z"/>
                                        </svg>
                                    </button>
                                    <button type="button" class="btn btn-primary text-bg-danger p-2 border-0" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="{{ route('veiculo.destroy', $veiculo->id) }}" data-bs-name="{{ $veiculo->veiculo }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="deleteModalLabel">Excluir veiculo?</h1>
                    <button   button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p id="text">Tem certeza que deseja excluir o veiculo</p>
                </div>
    ...
    <script>
        ...
        if (updateModal) {
            updateModal.addEventListener('show.bs.modal', event => {
                ...
                document.querySelector('#veiculo').value = name
...
<!-- SCRIPT DELETE -->
    <script>
        ...
        deleteModal.addEventListener('show.bs.modal', event => {
            ...
            document.querySelector('#text').innerHTML = `Tem certeza que deseja o veiculo ${name}`
