            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-3">
                ...
                <form class="p-3" action="{{ route('veiculo.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded" id="veiculo" placeholder="Insira aqui o nome do veiculo" name="veiculo">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control rounded" id="preco" placeholder="Insira aqui o preço do veiculo" name="preco">
                    </div>
